...
# 2022/08/22
# Remove pdf_book to prevent errors
# Change title to Introduction to Theoretical Ecology

unlink('_book', recursive = TRUE)

x = readLines('index.Rmd')
i = 1
s = paste0('title: "Introduction to Theoretical Ecology (', c('Bootstrap', 'Tufte'), ' Style)"')
...
bookdown::publish_book('2022_Fall_TheoEcol')
