...
**Part 2 - Visualizing stable age distribution**

For any diagonalizable n-by-n matrix $M$ with only one dominant eigenvalue, and for any n-by-1 vector $v$, $M^tv$ will shift to the same direction with the eigenvector of $M$ corresponding to the dominant eigenvalue. Here, we visualize this fact numerically.
```{r}
library(ggplot2)
set.seed(1234)
